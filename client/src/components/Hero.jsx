...
export default function Hero() {
    ...
    return (
        <>
            {/* Keyframes for dot grid pulse animation */}
            <style>{`
                @keyframes dotPulse {
                    0% { opacity: 0.5; }
                    100% { opacity: 0.8; }
            ...
            <div>
                <div className="relative overflow-hidden bg-gradient-to-b from-white to-blue-50 py-12 sm:py-16 md:py-20 lg:py-24">
                    ...
                    <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mb-16 md:mb-24 text-center">
                            ...
                            <p className="text-center text-base sm:text-lg md:text-xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
                                Watch how LeetAi personalizes your practice in under 2 minutes
                            </p>
                        ...
                        <div className="mb-4 text-center">
                            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
                                Why Choose{" "}
                                <span className="text-2xl md:text-3xl" style={{ fontFamily: "orbitron" }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                            {/* Card 1 */}
                            <div className="bg-white rounded-xl p-6 border border-blue-100 shadow-sm hover:shadow-md transition-all duration-300 group">
                        ...
                        <div className="py-16 md:py-24">
                            <div className="text-center mb-16">
                                ...
                                <div className="h-1 w-20 bg-blue-500 mx-auto rounded-full mb-8 mt-2"></div>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {/* Step 1 */}
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-blue-500 text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-6">
                                        1
                                    </div>
                                    <h3 className="text-xl font-bold text-gray-800 mb-3">Login and Integrate Your LeetCode Account</h3>
                                    <p className="text-gray-700">
                                        Sign in and link your LeetCode username so we can understand your progress and fetch your recent activity automatically.
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <p className="text-gray-700">
                                        If you're stuck, the platform shows how the problem relates to your past ones, guides your next steps, and keeps problem-solving engaging.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                {/* Pricing + CTA — outside the gradient section */}
                <div className="px-5 max-w-6xl mx-auto">
                    <div className="mt-16 mb-12 max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                            {/* Free Plan */}
                            <div className="bg-white rounded-xl p-4 sm:p-6 border border-green-200 shadow-sm hover:shadow-md transition-all duration-300">
                            ...
                            {/* Starter Plan */}
                            <div className="bg-white rounded-xl p-4 sm:p-6 border border-blue-200 shadow-sm hover:shadow-md transition-all duration-300">
                                <div className="text-center mb-4">
                            ...
                            {/* Power Plan */}
                            <div className="bg-white rounded-xl p-4 sm:p-6 border-2 border-purple-300 shadow-sm hover:shadow-md transition-all duration-300 relative">
