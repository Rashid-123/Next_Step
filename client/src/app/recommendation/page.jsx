...
//
import { fetch_All_Recommendations } from "@/lib/api/recommendations";
...
import { RecommendationListSkeleton } from "@/components/skeleton/recommendationSkeleton";
...
const {
    ...
    queryFn: () => fetch_All_Recommendations(token),
